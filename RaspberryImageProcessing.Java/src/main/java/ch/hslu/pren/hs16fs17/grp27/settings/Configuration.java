...
public class Configuration {
    ...
    public static final Pin DISPLAYDOTPIN = RaspiPin.GPIO_29;
    public static final Pin DISPLAYTOPMIDPIN = RaspiPin.GPIO_21;
    public static final Pin DISPLAYTOPLEFTPIN = RaspiPin.GPIO_22;
    public static final Pin DISPLAYTOPRIGHTPIN = RaspiPin.GPIO_23;
    public static final Pin DISPLAYMIDPIN = RaspiPin.GPIO_24;
    public static final Pin DISPLAYBOTTOMMIDPIN = RaspiPin.GPIO_25;
    public static final Pin DISPLAYBOTTOMLEFTPIN = RaspiPin.GPIO_26;
    public static final Pin DISPLAYBOTTOMRIGHTPIN = RaspiPin.GPIO_27;
